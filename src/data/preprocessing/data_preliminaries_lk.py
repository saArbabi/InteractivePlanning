...
m_df = pd.read_csv('./src/datasets/m_df_lk.txt', delimiter=' ',
                                                        header=None, names=m_col)
y_df = pd.read_csv('./src/datasets/y_df_lk.txt', delimiter=' ',
                                                        header=None, names=o_col)
f_df = pd.read_csv('./src/datasets/f_df_lk.txt', delimiter=' ',
                                                        header=None, names=o_col)
fadj_df = pd.read_csv('./src/datasets/fadj_df_lk.txt', delimiter=' ',
                                                        header=None, names=o_col)
...
# _m_df, _y_df, _f_df, _fadj_df = m_df, y_df, f_df, fadj_df
...
vis_trajs(80, training_episodes, 0)
